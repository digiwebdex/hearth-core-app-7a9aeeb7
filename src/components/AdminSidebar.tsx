import { LayoutDashboard, Building2, CreditCard, Crown, Ban, LogOut, ArrowLeft, Globe, ListChecks, Settings, Shield, MessageSquare, ScrollText, UserCog, FileText, BarChart3, UserPlus } from "lucide-react";
...
const adminItems = [
  ...
  { title: "Agencies", url: "/admin/tenants", icon: Building2 },
  { title: "Pending Signups", url: "/admin/pending-users", icon: UserPlus },
